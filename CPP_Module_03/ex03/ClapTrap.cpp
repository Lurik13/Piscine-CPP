...
/*   Updated: 2024/04/15 16:06:12 by lribette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	std::cout << HIGHLIGHTED_WHITE << "ClapTrap " << this->_name
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->getHitPoints() == 0)
	{
		std::cout << "\e[1m" << this->_name
		<< " can't take damage. ☠️\n" << RESET;
	}
	else if (amount < this->getHitPoints())
	{
		this->_hitPoints -= amount;
		std::cout << "\e[38;2;170;0;0;1m" << this->_name
		<< " took " << amount << " points of damage. 🤕\n"<< RESET;
	}
	else
	{
		std::cout << "\e[38;2;170;0;0;1m" << this->_name << " took "
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->getHitPoints() != 0 && this->getEnergyPoints() != 0)
	{
		std::cout << "\e[38;2;0;170;0;1m" << this->_name << " repaired " 
		<< amount << " points.\n" << RESET;
		this->_energyPoints--;
	}
	else
